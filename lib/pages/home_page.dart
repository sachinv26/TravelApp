            ...
            Container(
              child: Align(
                ...
                child: TabBar(
                  ...
                  indicator: CircleTabBarIndicator(color: AppColors.mainColor,radius: 4),
                  tabs: [
                    Tab(
                      text: "Places",
                    ),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        Container(
                          child: AppText(text: images.values.elementAt(index),size:15,color: AppColors.textColor2,
                          ),
                        )
                    ],
                  ),
...
class CircleTabBarIndicator extends Decoration{
  ...
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    ...
    return _CirclePaineter(
      color:color,
      radius:radius,
    );
  }
}
class _CirclePaineter extends BoxPainter{
  final Color color;
  double radius;
  _CirclePaineter({required this.color,required this.radius});
  @override
